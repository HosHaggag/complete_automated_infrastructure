...
sudo chmod 777 /simple-node-app
    ...
    spec:
      containers:
        - name: mynodejs-container
          image: us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mynode
          env:
            - name: DBuser
              value: "admin"
            - name: DBpass
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: mongo
          image: us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongo
        ...
        - name: mongo-sidecar
          image: us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongosidecar
          env:
...
echo "#########################"
sudo gcloud auth print-access-token | sudo docker login -u oauth2accesstoken --password-stdin us-central1-docker.pkg.dev
gcloud container clusters get-credentials workload-cluster --region=us-east1 --project=gcp-iti-401020
echo ""
echo ""
echo ""
echo "#########################"
...
echo "#########################"
cd /simple-node-app;
sudo docker build -t us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mynode -f Dockerfile.nodejs .;
sudo docker build -t us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongo -f Dockerfile.mongodb .;
sudo docker build -t us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongosidecar -f Dockerfile.sidecar .
...
echo "#########################"
sudo docker push us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mynode;
sudo docker push us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongo;
sudo docker push us-central1-docker.pkg.dev/gcp-iti-401020/my-nodejs-repo/mymongosidecar
